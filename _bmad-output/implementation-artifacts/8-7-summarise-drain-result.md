...
Keep it tiny — a single pure function and a focused unit test. Run `pnpm --dir plugins/flow/mcp-server build && pnpm --dir plugins/flow/mcp-server test` green before opening the PR. Do not touch the execution manifest or any `.flow/state` file.
