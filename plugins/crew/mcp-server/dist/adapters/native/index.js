    ...
    async listSourceStories() {
        ...
        for (const file of files) {
            ...
            try {
                ...
                console.warn(`[NativeAdapter] Skipping malformed native story '${file}' — it failed to parse and is fail-closed (NOT projected to to-do/). Fix the source and re-run /crew:scan. Reason: ${reason}`);
            }
        }
