...
This runbook walks the end-to-end operator flow for the `flow-drain` workflow
(`plugins/flow/workflows/drain.workflow.js`). For each story the drain claims the
...
> `/Users/you/projects/crew/plugins/flow/workflows/drain.workflow.js`).
>
