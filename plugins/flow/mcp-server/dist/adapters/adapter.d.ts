...
export type DisciplineViolationReason = {
    code: "missing-integration-ac" | "implicit-depends-on" | "missing-ship-gate" | "deps-drift-prose-vs-manifest" | "missing-verification" | "task-ac-ref-unresolved" | "missing-cited-sources" | "unresolvable-cited-source" | "invalid-verification-target" | "unresolvable-verification-target";
    field: string;
    detail: string;
};
/**
