    ...
    return acs.map((ac) => {
        ...
        if (verificationLines.length === 0) {
            throw new MalformedNativeStoryError({
                path: absPath,
                section: `## Acceptance Criteria / AC${ac.idx}`,
                reason: `AC${ac.idx} is missing its verification directive — ` +
        ...
        if (verificationLines.length > 1) {
            throw new MalformedNativeStoryError({
                path: absPath,
                section: `## Acceptance Criteria / AC${ac.idx}`,
                reason: `AC${ac.idx} has ${verificationLines.length} verification directives — ` +
        ...
        if (v.type !== "vitest" && v.type !== "artifact") {
            throw new MalformedNativeStoryError({
                path: absPath,
                section: `## Acceptance Criteria / AC${ac.idx}`,
                reason: `AC${ac.idx} verification directive type '${v.type}' is invalid — ` +
