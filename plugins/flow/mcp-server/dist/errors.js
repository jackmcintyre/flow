...
export class UnknownAdapterError extends DomainError {
    ...
    configPath;
    constructor(opts) {
        super(`'.flow/config.yaml' declares adapter '${opts.configuredAdapterName}' at ${opts.configPath}, ` +
...
export class RebaseConflictError extends DomainError {
    ...
    constructor(opts) {
        ...
        super(`pre-PR sync gate stopped: the story branch could not be rebased onto the ` +
...
export class ReviewerResultFileMissingError extends DomainError {
    ...
    sessionUlid;
    constructor(opts) {
        super(`No reviewer-result.json at ${opts.path} for ref ${opts.ref} (session ${opts.sessionUlid}). ` +
...
export class PrePrLeakDetectedError extends DomainError {
    ...
    constructor(opts) {
        ...
        super(`pre-PR leak gate stopped: the builder's edits reached the shared master copy ` +
            `(${opts.sharedRootPath}). ` +
...
export class PrePrTestFailedError extends DomainError {
    ...
    stderr;
    constructor(opts) {
        super(`pre-PR test gate failed: '${opts.testCommand}' (cwd: ${opts.testCwd}) ` +
            `exited with code ${opts.exitCode}. No pull request was opened. ` +
