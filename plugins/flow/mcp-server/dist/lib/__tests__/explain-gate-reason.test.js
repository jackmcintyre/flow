...
describe("explainGateReason", () => {
    ...
    describe("AC2 — unknown reasons and never throwing", () => {
        ...
        it("does not leak prototype-chain values for object-key-like inputs", () => {
            ...
            expect(explainGateReason("toString").toLowerCase()).toContain("unrecognized reason");
            expect(explainGateReason("constructor").toLowerCase()).toContain("unrecognized reason");
        });
    });
});
