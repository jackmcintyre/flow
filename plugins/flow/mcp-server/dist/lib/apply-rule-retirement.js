...
import { regenerateStandards, bumpPatchVersion, STANDARDS_REL_PATH, STANDARDS_SEED_VERSION, } from "./regenerate-standards.js";
import { lookupStandards } from "../state/lookup-standards.js";
import { StandardsDocMissingError, RuleNotFoundError, RetirementWouldEmptyRegistryError, } from "../errors.js";
import { parseRuleRegistry, serializeRuleRegistry, removeRuleNode, replaceRuleNode, DisciplineRuleSchema, } from "../schemas/discipline-rules.js";
...
// ---------------------------------------------------------------------------
async function renderRetirementDiff(proposal, ctx) {
 ...
 */
export function makeRuleRetirementApplyHandler(seamsIn = {}) {
    const seams = {
 ...
 */
function assertRetirementProposal(proposal) {
    if (proposal.type !== "rule-retirement") {
        throw new Error(`rule-retirement apply handler received a proposal of type '${proposal.type}'; ` +
