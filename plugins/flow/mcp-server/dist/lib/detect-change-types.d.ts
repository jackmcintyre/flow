 ...
 * @internal
 */
export declare function classifyPath(filePath: string): ChangeType[];
/**
 ...
 */
export declare function detectChangeTypes(changedPaths: string[], commitMessages: string[]): ChangeType[];
