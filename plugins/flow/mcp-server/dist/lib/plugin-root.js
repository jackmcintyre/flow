...
/**
 * Resolve the absolute path of the plugin root (`plugins/flow/`) by walking up
...
export function getPluginRoot() {
    ...
    throw new Error(`getPluginRoot: could not locate .claude-plugin/plugin.json above ${start}`);
}
