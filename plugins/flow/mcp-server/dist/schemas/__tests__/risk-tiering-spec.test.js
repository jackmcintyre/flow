...
import { RiskTieringSpecSchema, RuleSchema, DiffSizeThresholdsSchema, ChangeTypeSchema, } from "../risk-tiering-spec.js";
// ---------------------------------------------------------------------------
// Base fixtures
// ---------------------------------------------------------------------------
const BASE_LOW_RULE = {
...
describe("DiffSizeThresholdsSchema", () => {
    ...
    it("accepts when both are present and min <= max", () => {
        expect(DiffSizeThresholdsSchema.safeParse({ min_lines_changed: 10, max_lines_changed: 100 }).success).toBe(true);
    });
...
describe("RuleSchema", () => {
    ...
    it("accepts a rule with only diff_size_thresholds", () => {
        expect(RuleSchema.safeParse({ id: "r1", diff_size_thresholds: { min_lines_changed: 100 } }).success).toBe(true);
    });
