...
export declare const ADJUDICATION_DECISIONS: readonly ["ready", "escalate", "rework"];
export declare const AdjudicationDecisionSchema: z.ZodEnum<{
    escalate: "escalate";
    ready: "ready";
    rework: "rework";
}>;
 ...
 *                         escalates.
 */
export declare const AdjudicationVerdictSchema: z.ZodObject<{
    ref: z.ZodString;
    decision: z.ZodEnum<{
        escalate: "escalate";
        ready: "ready";
