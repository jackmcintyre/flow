...
export declare const HANDOFF_PHRASE_TEMPLATE = "Handoff to reviewer \u2014 story <story-id> ready for review.";
 ...
 */
export declare function parseHandoff(transcript: string, expectedRef: string): HandoffParseResult;
