...
const REQUIRED_INVOCATION_LINE = "spawn the planner subagent via Claude Code's `Task` tool against the catalogue prompt at `plugins/flow/catalogue/planner.md`";
