...
export declare const YIELD_PHRASE_TEMPLATE = "This sits in <domain>'s domain \u2014 handing off.";
/**
 ...
 */
export declare const YIELD_PHRASE_REGEX: RegExp;
export type YieldParseResult = {
    ok: true;
    domain: string;
} | {
    ok: false;
    reason: "drift" | "empty" | "no-yield";
};
/**
 ...
 */
export declare function parseYield(transcript: string): YieldParseResult;
