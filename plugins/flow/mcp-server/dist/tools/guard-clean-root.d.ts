 ...
 */
import { z } from "zod";
export declare const GuardCleanRootInputSchema: z.ZodObject<{
...
export interface GuardCleanRootResult {
    ...
    stashed: boolean;
    /** The dirty repo-relative paths (operational `.crew/**` already excluded). */
    paths: string[];
    /** The stash message used (present only when a stash was attempted). */
    stashMessage?: string;
}
export declare function guardCleanRoot(rawInput: unknown): Promise<GuardCleanRootResult>;
