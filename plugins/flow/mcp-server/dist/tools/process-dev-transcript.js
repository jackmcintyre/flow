...
export async function processDevTranscript(opts) {
    ...
    if (!handoffResult.ok) {
        ...
        chatLog.push(`handoff grammar drift — story ${ref} blocked. expected verbatim phrase: "Handoff to reviewer — story ${ref} ready for review." Edit the manifest to clear blocked_by and re-run /flow:start.`);
