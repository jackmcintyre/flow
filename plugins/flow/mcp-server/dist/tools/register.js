...
export function registerAllTools(server) {
    ...
    server.registerTool({
        name: "openCycle",
        description: "Open a new work cycle (Story native:01KT484NY4HCBPBTT6VEY1Q0CS). Mints a fresh " +
    ...
    server.registerTool({
        name: "recallLesson",
        description: "Return the full body of one lesson from a role's Knowledge section by id " +
