...
import {
  ...
  rankAndCap,
} from "../lib/parse-knowledge-section.js";
import { appendArchivedLessons } from "../lib/lesson-archive.js";
import { removeKnowledgeLessonsById, type UpdatedPersonaResult } from "../lib/update-knowledge-section.js";
...
export function assemblePrompt(
  ...
  const effectiveIndexLines =
    knowledgeIndexLines ?? buildKnowledgeIndex(persona.sections["Knowledge"]);
 ...
 */
export function buildKnowledgeIndexFromEntries(
  lessons: import("../lib/parse-knowledge-section.js").ParsedLessonEntry[],
): string[] {
  if (lessons.length === 0) {
