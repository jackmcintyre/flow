...
import {
  ...
  ReviewerResultFileMissingError,
} from "../errors.js";
 ...
 */
export async function recordReviewerLesson(
  opts: RecordReviewerLessonOptions,
): Promise<RecordReviewerLessonResult> {
  ...
  const merged: ReviewerResultFileShape = {
    ...existing,
    lesson: parsed.data,
  };
